package cn.com.lbt.lbtlibrary.utils.app.toast;
...
import cn.com.lbt.lbtlibrary.DevUtils;
import cn.com.lbt.lbtlibrary.R;
...
public final class ToastTintUtils {
    ...
    // == 样式相关 ==
    // 默认样式
    private static Style defaultStyle = new DefaultStyle();
    // Normal 样式
    private static Style normalStyle = new NormalStyle();
    // Info 样式
    private static Style infoStyle = new InfoStyle();
    // Warning 样式
    private static Style warningStyle = new WarningStyle();
    // Error 样式
    private static Style errorStyle = new ErrorStyle();
    // Success 样式
    private static Style successStyle = new SuccessStyle();
    // =
    // info icon
     ...
     * @param toastFilter
     */
    public static void setToastFilter(Filter toastFilter) {
...
//    }
    ...
    /** custom Toast */
    public static void custom(Style style, String text) {
        custom(true, null, style, text, Toast.LENGTH_SHORT, null);
    }

    /** custom Toast */
    public static void custom(Style style, String text, int duration) {
        custom(true, null, style, text, duration, null);
    }

    /** custom Toast */
    public static void custom(Style style, String text, Drawable icon) {
        custom(true, null, style, text, Toast.LENGTH_SHORT, icon);
    }

    /** custom Toast */
    public static void custom(Style style, String text, int duration, Drawable icon) {
    ...
    /** custom Toast */
    public static void custom(boolean isSingle, Style style, String text) {
        custom(isSingle, null, style, text, Toast.LENGTH_SHORT, null);
    }

    /** custom Toast */
    public static void custom(boolean isSingle, Style style, String text, int duration) {
        custom(isSingle, null, style, text, duration, null);
    }

    /** custom Toast */
    public static void custom(boolean isSingle, Style style, String text, Drawable icon) {
        custom(isSingle, null, style, text, Toast.LENGTH_SHORT, icon);
    }

    /** custom Toast */
    public static void custom(boolean isSingle, Style style, String text, int duration, Drawable icon) {
    ...
    /** custom Toast */
    public static void custom(Context context, Style style, String text) {
        custom(true, context, style, text, Toast.LENGTH_SHORT, null);
    }

    /** custom Toast */
    public static void custom(Context context, Style style, String text, int duration) {
        custom(true, context, style, text, duration, null);
    }

    /** custom Toast */
    public static void custom(Context context, Style style, String text, Drawable icon) {
        custom(true, context, style, text, Toast.LENGTH_SHORT, icon);
    }

    /** custom Toast */
    public static void custom(Context context, Style style, String text, int duration, Drawable icon) {
    ...
    /** custom Toast */
    public static void custom(boolean isSingle, Context context, Style style, String text) {
        custom(isSingle, context, style, text, Toast.LENGTH_SHORT, null);
    }

    /** custom Toast */
    public static void custom(boolean isSingle, Context context, Style style, String text, int duration) {
        custom(isSingle, context, style, text, duration, null);
    }

    /** custom Toast */
    public static void custom(boolean isSingle, Context context, Style style, String text, Drawable icon) {
     ...
     * @param icon 图标
     */
    public static void custom(boolean isSingle, Context context, Style style, String text, int duration, Drawable icon) {
        // 获取View
     ...
     * @return
     */
    private static View inflaterView(Context context, Style style, String text, Drawable icon) {
        if (context == null) {
            context = DevUtils.getContext();
        }
        // 如果样式为 null, 则不处理
        ...
        if (context != null) {
            try {
                ...
                // 初始化View
                final ImageView toastIcon = toastLayout.findViewById(R.id.vid_dtl_toast_igview);
                final TextView toastTextView = toastLayout.findViewById(R.id.vid_dtl_toast_tv);
                ...
                if (drawableFrame == null) {
                    drawableFrame = getDrawable(context, R.drawable.dev_toast_frame);
                    // 判断是否需要着色
     ...
     */
    private final static Filter sPriToastFilter = new Filter() {
